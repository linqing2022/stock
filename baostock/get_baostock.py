...
class Downloader(object):
    def __init__(self,
        ...
        self.fields = "date,code,open,high,low,close,preclose,volume,amount," \
...
if __name__ == '__main__':
    # 获取全部股票的日K线数据
    mkdir('./baostock/train')
    downloader = Downloader('./baostock/train', date_start='1990-01-01', date_end='2020-09-01')
    downloader.run()

    # mkdir('./baostock/test')
    # downloader = Downloader('./baostock/test', date_start='2020-09-01', date_end='2022-11-10')
    # downloader.run()
