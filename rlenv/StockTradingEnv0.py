...
class StockTradingEnv(gym.Env):
    ...
    def __init__(self, df):
        ...
        self.observation_space = spaces.Box(
            low=0, high=1, shape=(13,), dtype=np.float16)
    ...
    def _next_observation(self):
        obs = np.array([
            ...
            # self.df.loc[self.current_step, 'pct_chg'] / 100,
            # self.df.loc[self.current_step, 'pe_ttm'] / 100,
            # self.df.loc[self.current_step, 'pb'] / 100,
            self.df.loc[self.current_step, 'ps_ttm'] / 400,
